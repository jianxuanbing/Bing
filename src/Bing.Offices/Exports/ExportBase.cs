...
namespace Bing.Offices.Exports
{
    ...
    public abstract class ExportBase:IExport
    {
        ...
        /// 工作表
        /// </summary>
        protected readonly IExcelSheet Sheet;
        ...
        /// <returns></returns>
        public IExport Head(params IExcelCell[] cells)
        {
        ...
        /// <param name="cells">单元格集合</param>
        /// <returns></returns>
        public IExport Foot(params IExcelCell[] cells)
        {
        ...
        /// <returns></returns>
        public IExport Write(string direcotry, string fileName = "")
        {
